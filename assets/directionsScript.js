...
function initMap(latitude, longitude) {
  ...
  const stadiums = Array(
    ...
    Stadium('Lower.com Field CBUS', 39.9685, -83.0171),
    ...
    Stadium('GEODIS Park NAS', 36.130257 , -86.765907),
  ...
  function handleStadiumClick(stadiumDivEl) {
    let stadiumIndex = stadiumDivEl.getAttribute('data-stadium-index')
    console.log(stadiumIndex) 
